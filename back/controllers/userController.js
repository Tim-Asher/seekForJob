...
exports.getUsers = asyncHandler(async (req, res, next) => {
  ...
  if (profession) {
    searchCriteria.profession = { $regex: profession, $options: "i" }; // Case-insensitive search
  }

  if (city) {
    searchCriteria.city = { $regex: city, $options: "i" }; // Case-insensitive search
  }

  if (experience) {
    // Convert experience to a number and find exact matches
    searchCriteria.experience = { $eq: Number(experience) };
  }
