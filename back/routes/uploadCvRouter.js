...
router.post("/uploadCv", authController.protect, UploadCvController.uploadCv);
router
  .route("/getUserCvs")
  .get(authController.protect, UploadCvController.getUserCVs);
router
  .route("/deleteCv/:id")
  .delete(authController.protect, UploadCvController.deleteCv);
router
  .route("/downloadCv/:fileName")
  .get(authController.protect, UploadCvController.downloadCv);
