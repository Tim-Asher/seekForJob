...
router.get("/statistics", jobsController.getStatistics);
...
router.get(
  "/getAllJobsByEmployerId/:employerId",
  jobsController.getAllJobsByEmployer
);
...
router
  ...
  .get(authController.protect, jobsController.getEmployerJobs);
router.delete(
